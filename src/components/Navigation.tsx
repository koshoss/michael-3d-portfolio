          ...
          <div className="flex items-center gap-1 md:gap-4">
            ...
            <div className="flex items-center ml-2">
              <img 
                ...
                className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-primary/30 object-cover transition-all duration-300 hover:border-primary"
